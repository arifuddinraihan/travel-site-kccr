        ...
        <div className='container mx-auto min-h-screen mt-9'>
            <div className="mx-auto md:w-4/5 lg:w-2/5 bg-white rounded-lg shadow-lg dark:bg-white-800 lg:max-w-4xl">
                <div className="w-full px-6 py-8 md:px-8">
                    ...
                    <p className="text-xl text-center text-gray-600 dark:text-black">
                        Welcome back!
                    </p>

                    <a href="#" className="flex items-center justify-center mt-4 text-gray-600 transition-colors duration-300 transform border rounded-lg dark:border-gray-700 text-black-200 hover:bg-gray-50 dark:hover:bg-gray-600">
                        ...
                        <span className="w-5/6 px-4 py-3 font-bold text-center text-black">Sign up with Google</span>
                    </a>

                    <div className="flex items-center justify-between mt-4">
                        <span className="w-1/5 border-b dark:border-gray-600 lg:w-1/4"></span>

                        <a href="#" className="text-xs text-center text-gray-500 uppercase text-black-400 hover:underline">or login
                            with email</a>
                    ...
                    <div className="flex items-center justify-between mt-4">
                        ...
                        <a href="#" className="text-xs text-gray-500 uppercase text-black-400 hover:underline">or sign up</a>
